...
import 'package:main/Kartlar/GeceHayati/japonyagecehayati.dart';
import 'package:main/Kartlar/Ulasim/japonyaulasim.dart';
import 'package:main/Kartlar/GezilecekYerler/japonyagezilecekyerler.dart';
  ...
  Widget buildCard(int index) {
    ...
    return GestureDetector(
      ...
      case 0:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => JaponyaYemek()), // FinlandiyaYemek sayfasına yönlendirme
        );
        break;
      ...
      case 1:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => JaponyaGezilecekYerler()), // FinlandiyaGezilecekYerler sayfasına yönlendirme
        );
        break;
      case 2:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => JaponyaGeceHayati()), // FinlandiyaGeceHayati sayfasına yönlendirme
        );
        break;
      case 3:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => JaponyaUlasim()), // FinlandiyaUlasim sayfasına yönlendirme
        );
        break;
      default:
        break;
